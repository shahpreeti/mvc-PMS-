...
public class SaveSubFormBean {
	...
	{ 
		...
		case 3: return "Form submitted successfully and mailed to ....";
		default: return "";
		}
	}
	public int saveForm()
	...
	public void submitForm()
	{
		...
		if(count==0)
		{
			...
			String sql="update appr_empl_flow set Status = 3 where apprEmpId= ? and phaseid=?";
			UpdateDB ob=new UpdateDB();
